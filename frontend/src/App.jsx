...
//       query: input,
//     });
//     setMessages((msgs) => [...msgs, { role: "ai", content: res.data.answer }]);
//     setInput("");
//   };
...
//         <label
//           htmlFor="pdf-upload"
//           className="ml-auto px-4 py-2 bg-emerald-500 text-white rounded-xl"
//         >
//           📁 Upload PDF
//         </label>
//         <input
...
//         <div className="flex-1 bg-white/5 backdrop-blur-xl rounded-2xl p-6 flex flex-col">
//           <div>Chat Area</div>
//           {messages.map((msg, i) => (
//             <div
//               key={i}
...
//           <div className="mt-auto h-20 bg-white/5 rounded-xl flex items-center px-4">
//             <input
...
//           </div>
//         </div>
//         <div className="w-96 bg-white/5 backdrop-blur-xl rounded-2xl p-6">
//           PDF Panel
//         </div>
//       </div>
...
//   return (
//     <div className="fixed top-6 right-6 bg-gradient-to-r from-gray-800 to-gray-900 text-white px-6 py-4 rounded-2xl shadow-2xl flex items-center gap-4 animate-slideIn z-50 min-w-[320px]">
...
//       setMsg(JSON.stringify(data.status));
//     } catch (error) {
...
//       const response = await fetch("http://localhost:8000/upload-pdf-stream", {
//         method: "POST",
//         body: formData,
//       });
...
//       {/* Toast Container - Stacked vertically */}
...
//               <button
//                 onClick={sendMessage}
//                 className="px-4 py-2 bg-indigo-500 hover:bg-indigo-600 rounded-lg transition-colors font-medium"
//               >
//                 Send
//               </button>
//             </div>
...
//                   <p className="font-medium mt-1">{pdfStatus.filename}</p>
//                 </div>
//                 <div className="p-3 bg-white/10 rounded-lg">
